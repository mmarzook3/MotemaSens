...
The LCD mic trace is intentionally slowed to quarter visual speed by averaging four mic display points before they enter the screen history. This makes the LUB-DUB heart sound easier to see while keeping Core 0 acquisition and USB/WiFi CSV logging at the normal sample cadence.
